...
- Abril Fatface: do not use for new chrome. Media uses a centered EVOLVED [megaphone disc] MEDIA lockup, not a newspaper nameplate. Fit uses EVOLVED PR[barbell disc]S FIT. Both are Bebas Neue Regular.
