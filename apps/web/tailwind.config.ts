  ...
  theme: {
    extend: {
      ...
      spacing: {
        ...
        'ep-12': 'var(--space-12)',
        'ep-16': 'var(--space-16)',
        'ep-stack':    'var(--space-stack)',
        'ep-stack-lg': 'var(--space-stack-lg)',
        'ep-ad':       'var(--space-ad)',
        'ep-ad-lean':  'var(--space-ad-lean)',
        'ep-section':  'var(--space-section)',
        'ep-rule':     'var(--space-rule)',
        'ep-page-top': 'var(--space-page-top)',
        'ep-card':     'var(--space-card)',
      },
      borderRadius: {
