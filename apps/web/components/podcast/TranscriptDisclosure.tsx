...
// Client disclosure UI for the podcast transcript. Lifted out of the old
// TranscriptSection so the data fetch can live in an async RSC and stream
// independently of the page shell.
export function TranscriptDisclosure({ transcript }: TranscriptDisclosureProps) {
