...
// Primary DAU loops on the thumb bar. "Today" is the consolidated daily
// dashboard (goals live there now). Podcast under More.
const TABS: TabItem[] = [
  { label: 'Today',     href: '/home',       match: /^\/home$/,      icon: <TargetIcon /> },
