...
export function PostCard({ post, currentUserId, currentUser, onReact, onBookmark, activeFilter, isAdmin }: PostCardProps) {
  ...
  const actionBtnClass = `flex items-center gap-1.5 font-condensed font-semibold uppercase text-[12px] sm:text-[11px] tracking-wide hover:text-[#ef0e30] transition-colors duration-150 ${isLightCard || !isDark ? 'text-[#1b3c5a]/70' : 'text-[#7a8a96]'}`
