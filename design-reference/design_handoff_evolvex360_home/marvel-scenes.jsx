/* global React */
// ──────────────────────────────────────────────────────────────────────
// Marvel-cinematic SkyScene — six time-of-day panels, novel comic-meets-editorial
// On-brand strict palette: navy #0A0F18 / #1B2A4A, red #ef0e30 / #C9302A, gold #C9A84C
// Atmosphere only — no characters, no symbols. Each scene is its own composition.
// ──────────────────────────────────────────────────────────────────────
...
// Reusable defs — halftone, grain, scanlines
function CommonDefs() {
  return (
    <defs>
      {/* Halftone — small ink dots over rect */}
      ...
      <linearGradient id="haze-bottom" x1="0" y1="0" x2="0" y2="1">
        <stop offset="0%" stopColor={NAVY_DEEP} stopOpacity="0"/>
        <stop offset="100%" stopColor={NAVY_DEEP} stopOpacity="0.85"/>
      </linearGradient>
...
// Radiating sun-burst behind a navy horizon with halftone grit
// ──────────────────────────────────────────────────────────────────────
function EarlyMorning() {
  ...
  const cx = 50, cy = 95;
  for (let i = 0; i < 24; i++) {
    const angle = (i / 24) * 180 - 180; // upper hemisphere only
  ...
  return (
    <svg viewBox="0 0 100 60" preserveAspectRatio="xMidYMid slice"
      ...
      <CommonDefs/>
      {/* Sky gradient — deep navy → warm gold horizon */}
      <defs>
      ...
      <g opacity="0.55">
        {rays.map((r, i) => (
          <line key={i} x1={cx} y1={cy} x2={r.x2} y2={r.y2}
            stroke={GOLD_LT} strokeWidth={r.w} strokeLinecap="round"/>
        ))}
      </g>
      ...
      {/* Halftone band over horizon */}
      <rect x="0" y="48" width="100" height="12" fill="url(#halftone-gold)" opacity="0.6"/>

      {/* Distant skyline silhouette */}
      <path d="M0 52 L8 52 L9 49 L13 49 L13 51 L18 51 L18 47 L22 47 L22 50 L28 50 L28 46 L31 46 L31 51 L38 51 L40 48 L42 48 L43 51 L52 51 L52 47 L56 47 L57 50 L62 50 L62 45 L66 45 L67 50 L74 50 L75 47 L79 47 L79 51 L86 51 L86 48 L91 48 L91 51 L100 51 L100 60 L0 60 Z"
        fill={NAVY_DEEP}/>
...
// Tech-schematic skyline with arc-circles and grid, on navy
// ──────────────────────────────────────────────────────────────────────
function MidMorning() {
  return (
    <svg viewBox="0 0 100 60" preserveAspectRatio="xMidYMid slice"
      ...
      {/* Schematic skyline — line drawing only */}
      ...
      {/* Solid silhouette underneath for weight */}
...
// Concentric mandala / radial geometry with deep navy + gold tracery
// ──────────────────────────────────────────────────────────────────────
function Midday() {
  const petals = 16;
  return (
...
// Painterly soft haze, low sun, layered silhouette skyline
// ──────────────────────────────────────────────────────────────────────
function EarlyEvening() {
  return (
    <svg viewBox="0 0 100 60" preserveAspectRatio="xMidYMid slice"
      ...
      {/* Massive sun glow low on horizon */}
      ...
      {/* Far skyline — softer color */}
      <path d="M0 47 L6 47 L6 44 L11 44 L11 47 L16 47 L16 42 L21 42 L21 47 L28 47 L28 41 L34 41 L34 47 L41 47 L41 43 L46 43 L46 47 L100 47 L100 60 L0 60 Z"
        fill={RED_DEEP} opacity="0.85"/>

      {/* Near skyline — solid navy */}
      <path d="M0 51 L4 51 L4 46 L8 46 L8 51 L14 51 L14 48 L19 48 L19 44 L23 44 L23 51 L30 51 L30 47 L35 47 L35 51 L42 51 L43 49 L46 49 L47 51 L54 51 L54 45 L58 45 L58 51 L66 51 L67 48 L70 48 L71 51 L78 51 L78 46 L82 46 L82 51 L88 51 L88 49 L92 49 L92 51 L100 51 L100 60 L0 60 Z"
        fill={NAVY_DEEP}/>
...
// High contrast Marvel-poster — red sky + navy ground, halftone moon
// ──────────────────────────────────────────────────────────────────────
function Evening() {
  return (
    <svg viewBox="0 0 100 60" preserveAspectRatio="xMidYMid slice"
      ...
      {/* Halftone gradient — densest at bottom */}
      <rect x="0" y="0" width="100" height="60" fill="url(#halftone-red)" opacity="0.25"/>

      {/* Moon — gold disc with red shadow crescent */}
      ...
      {/* Skyline silhouette — heavy navy */}
      <path d="M0 50 L5 50 L5 44 L10 44 L10 50 L16 50 L16 41 L20 41 L20 38 L24 38 L24 50 L31 50 L31 46 L35 46 L35 50 L42 50 L42 38 L46 38 L46 34 L50 34 L50 38 L54 38 L54 50 L62 50 L62 42 L66 42 L66 50 L74 50 L74 46 L78 46 L78 40 L82 40 L82 50 L90 50 L90 44 L95 44 L95 50 L100 50 L100 60 L0 60 Z"
        fill={NAVY_DEEP}/>
...
// Deep navy with gold constellation, halftone nebula, faint city
// ──────────────────────────────────────────────────────────────────────
function Night() {
  // Deterministic stars
  const stars = [];
  ...
  // Constellation — 6 connected points (loose abstract shape)
  const constellation = [
    { x: 18, y: 14 }, { x: 26, y: 8 }, { x: 34, y: 16 },
    { x: 40, y: 10 }, { x: 48, y: 18 }, { x: 56, y: 12 },
  ];
...
// ──────────────────────────────────────────────────────────────────────
function MarvelSkyScene({ period }) {
  const Comp = {
...
window.MarvelSkyScene = MarvelSkyScene;
