...
export function HabitCard({
  ...
  return (
    <div
      ...
      style={{
        backgroundColor: completed ? 'rgba(10,191,163,0.18)' : 'rgba(255,255,255,0.08)',
        borderLeft: `3px solid ${color}`,
        borderTop: `1px solid ${isDragOver ? 'rgba(201,168,76,0.4)' : completed ? `${color}50` : 'rgba(255,255,255,0.15)'}`,
        borderRight: `1px solid ${isDragOver ? 'rgba(201,168,76,0.4)' : completed ? `${color}50` : 'rgba(255,255,255,0.15)'}`,
        borderBottom: `1px solid ${isDragOver ? 'rgba(201,168,76,0.4)' : completed ? `${color}50` : 'rgba(255,255,255,0.15)'}`,
